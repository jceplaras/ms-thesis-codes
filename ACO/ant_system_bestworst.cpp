...
int main(int argc, char ** argv) {
    ...
    if(argc < 7) {
        printf("Usage: ant_colony_rankbased_pcenter <no_of_ants> <p> <iter> <alpha> <beta> <evap> < <input cgraph>\n");
    ...
    FORN(iter,max_iteration) {
        ...
        */
        ...
        //Add pheromone to global best ant
        FORN(j,number_of_facilities) {
        ...
        FORN(j,number_of_facilities) {
            ...
            printf("Evaporating additional pheromone to city %d\n",city_number);
            pheromone_level_city[city_number] = (1-pheromone_evaporation_rate) * pheromone_level_city[city_number];
        }
